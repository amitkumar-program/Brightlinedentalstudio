  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-slate-900 aspect-[16/10]">
        ...
        <div className="absolute bottom-4 right-4 z-10 opacity-0 group-hover:opacity-100 transition-opacity p-2 rounded-full bg-white/80 backdrop-blur-md text-foreground shadow-md">
              ...
              <div className="p-4 bg-slate-950 relative flex items-center justify-center overflow-hidden max-h-[60vh]">
                {selectedItem.image ? (
                  ...
                  <MediaPlaceholder
                    ...
                    subtext="High-resolution gallery transformation asset"
                  />
                )}
              </div>
